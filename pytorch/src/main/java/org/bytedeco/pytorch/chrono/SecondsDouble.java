...
@Name("std::chrono::duration<double>") @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class SecondsDouble extends Pointer {
    public SecondsDouble() {  super((Pointer)null); allocate(); };
    private native void allocate();
    public SecondsDouble(double r) {  super((Pointer)null); allocate(r); };
    private native void allocate(double r);
    public SecondsDouble(Nanoseconds d) {  super((Pointer)null); allocate(d); };
    private native void allocate(@Const @ByRef Nanoseconds d);
    public SecondsDouble(Seconds d) {  super((Pointer)null); allocate(d); };

...
@Name("std::chrono::microseconds") @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class Microseconds extends Pointer {
    public Microseconds() {  super((Pointer)null); allocate(); };
    private native void allocate();
    public Microseconds(long r) {  super((Pointer)null); allocate(r); };

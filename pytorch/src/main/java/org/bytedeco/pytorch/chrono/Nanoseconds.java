...
@Name("std::chrono::nanoseconds") @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class Nanoseconds extends Pointer {
    public Nanoseconds() {  super((Pointer)null); allocate(); };
    private native void allocate();
    public Nanoseconds(long r) {  super((Pointer)null); allocate(r); };
    private native void allocate(long r);
    public Nanoseconds(Microseconds d) {  super((Pointer)null); allocate(d); };
    private native void allocate(@Const @ByRef Microseconds d);
    public Nanoseconds(Milliseconds d) {  super((Pointer)null); allocate(d); };
    private native void allocate(@Const @ByRef Milliseconds d);
    public Nanoseconds(Seconds d) {  super((Pointer)null); allocate(d); };
    private native void allocate(@Const @ByRef Seconds d);
    public Nanoseconds(Minutes d) {  super((Pointer)null); allocate(d); };
    private native void allocate(@Const @ByRef Minutes d);
    public Nanoseconds(Hours d) {  super((Pointer)null); allocate(d); };

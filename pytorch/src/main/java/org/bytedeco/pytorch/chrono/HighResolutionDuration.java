...
@Name("std::chrono::high_resolution_clock::duration") @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class HighResolutionDuration extends Pointer {
    public HighResolutionDuration() {  super((Pointer)null); allocate(); };
    private native void allocate();
    public HighResolutionDuration(long r) {  super((Pointer)null); allocate(r); };

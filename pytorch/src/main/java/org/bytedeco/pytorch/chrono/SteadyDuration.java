...
@Name("std::chrono::steady_clock::duration") @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class SteadyDuration extends Pointer {
    public SteadyDuration() {  super((Pointer)null); allocate(); };
    private native void allocate();
    public SteadyDuration(long r) {  super((Pointer)null); allocate(r); };

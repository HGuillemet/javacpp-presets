...
@Name("std::chrono::hours") @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class Hours extends Pointer {
    public Hours() {  super((Pointer)null); allocate(); };
    private native void allocate();
    public Hours(long r) {  super((Pointer)null); allocate(r); };
